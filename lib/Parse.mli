...
(**
    Functions for parsing make programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a make program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.makefile, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a make program from a file into a typed OCaml CST.
